...
//intersection() {
   union() {
      guide();
      translate([0, 25.0, 0]) guide();
      translate([0, 50.0, 0]) guide();
   }
   translate([guideLen / 2 -mountWidth * 1.5, 0, 0]) cube([mountWidth, 50.0, guideThick]);
   translate([-guideLen / 2 +mountWidth * 0.5, 0, 0]) cube([mountWidth, 50.0, guideThick]);
//}